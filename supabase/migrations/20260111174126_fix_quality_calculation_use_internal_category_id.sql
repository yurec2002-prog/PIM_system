/*
  # Fix Quality Calculation - Use internal_category_id

  1. Changes
    - Update calculate_product_quality function to use internal_category_id
    - This field exists in the products table
*/
